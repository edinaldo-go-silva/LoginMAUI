namespace RoteiroFiscalObra
{
    ...
    public class RoteiroFiscalObraBehavior : Behavior<ContentPage>
    {
        ...
        protected override void OnAttachedTo(ContentPage bindable)
        {
            ...
            this.dataForm = bindable.FindByName<SfDataForm>("RoteiroFiscalObra");
        ...
        {
            if (e.DataFormItem != null && e.DataFormItem.FieldName == nameof(RoteiroFiscalObraModel.Email) && e.DataFormItem is DataFormTextEditorItem textItem)
            {
